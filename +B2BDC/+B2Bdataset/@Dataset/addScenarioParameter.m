...
%  addScenarioParameter(obj,Svalue,Sname) adds the input scenario parameters to the
%  dataset. The values and names of the scenario parameters are specified by the input
%  Svalue and Sname, respectively.
