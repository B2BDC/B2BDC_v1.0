...
%  setModelDiscrepancy(obj, QOIindex, fMD) sets the discrepancy-function, specified by
%  fMD, to the QOIs specified by QOIindex. If QOIindex and fMD are cell arrays, they
%  correspond to different QOI groups. In this case, the discrepancy-function coefficients
%  have a default prior uncertainty range of [-10 10].

%  setModelDiscrepancy(obj, QOIindex, fMD, Range) sets the discrepancy-function, specified by fMD, to the QOIs specified by QOIindex. If QOIindex and fMD are cell arrays,
%  they correspond to different QOI groups. In this case, the prior uncertainty range of
%  discrepancy-function coefficients is specified by Range.
