...
%   xPos = calVarBounds(obj) calculates the posterior uncertainty bound of all parameters. 
%   The option variable is set to be the default B2BDC option.
%
%   xPos = calVarBounds(obj, index) calculates the posterior uncertainty bound of the
%   parameters specified by index. The option variable is set to be the default B2BDC
%   option. 
%   
%   xPos = calVarBounds(obj, index, opt) calculates the posterior uncertainty bound of
%   the parameters specified by index. The option variable is specified by opt.
